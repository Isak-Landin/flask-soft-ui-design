...
function customCheckColor(){
	...
	if (logoHeader !== "white") {
		$('.logo-header .navbar-brand').attr('src', '../static/dashboard_assets/img/kaiadmin/logo_light.svg');
	} else {
		$('.logo-header .navbar-brand').attr('src', '../static/dashboard_assets/img/kaiadmin/logo_dark.svg');
	}
}
